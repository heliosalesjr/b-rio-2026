...
const perguntas = [
  ...
  {
    id: 9,
    enunciado: "No contexto do Módulo 1, o que a frase \"Pequenos Projetos Didáticos Ativos\" representa em termos de aplicação da Educação Financeira em sala de aula?",
    opcoes: [
      "A) A substituição completa de todas as atividades de matemática",
      "B) Uma forma de concretizar a Aprendizagem Baseada em Projetos (ABP) com atividades menores e práticas",
      "C) O estudo teórico de longas teses sobre economia",
      "D) A criação de um orçamento anual para a gestão escolar",
    ],
    correta: 1,
    feedbacks: [
      "Incorreto. Os Pequenos Projetos não visam substituir todas as atividades de matemática.",
      "Exatamente! Representam uma forma prática de concretizar a ABP através de atividades menores e mais aplicáveis.",
      "Incorreto. A proposta é prática, não teórica com longas teses.",
      "Incorreto. Não se trata de criar orçamento para gestão escolar, mas de projetos didáticos para os alunos.",
    ],
  },
  {
    id: 10,
